...
static const char *TAG = "mero-cam";

// --- Замени на свои данные ---
#define WIFI_SSID "MALADESH"
#define WIFI_PASS "b2314g392sbb"
// ----------------------------

// AI-Thinker ESP32-CAM + OV3660 pinout
...
static esp_err_t camera_init(void) {
    camera_config_t config = {
        ...
        .jpeg_quality = 12,              // 0-63, меньше = лучше качество
        .fb_count     = 2,
...
static httpd_handle_t start_webserver(void) {
    ...
    ESP_LOGI(TAG, "Stream ready at http://<IP>/stream");
    return server;
}
